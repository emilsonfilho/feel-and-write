const initialDatabase = {
  ...
  messages: [
      ...
      {
        id: 2,
        message: "O fracasso é apenas a oportunidade de começar de novo, desta vez de forma mais inteligente."
      },
      {
        id: 3,
      ...
      {
        id: 5,
        message: "A vida é 10% do que acontece comigo e 90% de como eu reajo a isso."
      },
      {
        id: 6,
      ...
      {
        id: 10,
        message: "O sucesso não é garantido, mas o fracasso é certo se você não tentar."
      }
    ],
  dayToDays: []
}
